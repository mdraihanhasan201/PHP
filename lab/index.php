...
if (isset($_POST['submit'])){
    ...
    $sql = "insert into q_info (orderNO,productname,quantity,price,dateofpurchase,timeofpurchase) values ('$orderNO','$productname','$quantity','$price','$dateofpurchase','$timeofpurchase')";
